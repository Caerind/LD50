...
{
    public static void DrawCube(Vector3 pos, Color col, Vector3 scale, float duration = 0.0f)
    {
    ...
    public static void DrawRect(Rect rect, Color col, float duration = 0.0f)
    {
        ...
        DebugDisplay.DrawRect(pos, col, scale, duration);
    }

    public static void DrawRect(Vector3 pos, Color col, Vector3 scale, float duration = 0.0f)
    {
        Vector3 halfScale = scale * 0.5f;
